...
namespace HomeWork10
{
    ...
    static void Main(string[] args)
    {
            ...
            List<OrderDetail> detail1 = new List<OrderDetail>() { new OrderDetail("1", "C#", 1.0, 100) };
            List<OrderDetail> detail2 = new List<OrderDetail>() { new OrderDetail("2", "计组", 2.0,100) };
            List<OrderDetail> detail3 = new List<OrderDetail>() { new OrderDetail("3", "JAVA", 100.0, 500) };
            List<OrderDetail> detail4 = new List<OrderDetail>() { new OrderDetail("4", "数据结构", 800.0, 5500) };
            List<OrderDetail> detail5 = new List<OrderDetail>() { new OrderDetail("5", "概率论",9,100) };
